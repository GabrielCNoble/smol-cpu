...
/*
    alu_op:
        ...
        12-15:  operation
*/
#define ALU_OP(op, reg, update_flags) UOP( ((op) << 8) | ((reg) << 4) | (update_flags && 1), ISA_FUNC_ALU)
...
/*
    ftest:
        8-15: flag test to be performed
*/
...
enum ISA_OPCODES
{
    ...
    /* INCOMPLETE IN HARDWARE */
    ISA_OPCODE_ADC_ACCW_IMM16,
    /* INCOMPLETE IN HARDWARE */
    ISA_OPCODE_ADC_ACCW_BASE,
    /* INCOMPLETE IN HARDWARE */
    ISA_OPCODE_ADC_BASE_IMM16,
    /* INCOMPLETE IN HARDWARE */
    ISA_OPCODE_ADC_BASE_ACCW,
    ...
    /* INCOMPLETE IN HARDWARE */
    ISA_OPCODE_SBB_ACCW_IMM16,
    /* INCOMPLETE IN HARDWARE */
    ISA_OPCODE_SBB_ACCW_BASE,
    /* INCOMPLETE IN HARDWARE */
    ISA_OPCODE_SBB_BASE_IMM16,
    /* INCOMPLETE IN HARDWARE */
    ISA_OPCODE_SBB_BASE_ACCW,
    ...
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_ADD_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_ADD_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_ADD_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SUB_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SUB_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SUB_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_MUL_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_MUL_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_MUL_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_DIV_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_DIV_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_DIV_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_CMP_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_CMP_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_CMP_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_AND_DST_I_IMM16, 
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_AND_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_AND_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_OR_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_OR_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_OR_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_XOR_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_XOR_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_XOR_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SHL_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SHL_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SHL_DST_I_SRC_IMM16,

    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SHR_DST_I_IMM16,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SHR_DST_I_SRC,
    /* NOT IN THE UOP ROM/ ASSEMBLER */
    ISA_OPCODE_SHR_DST_I_SRC_IMM16,

    ISA_OPCODE_LAST
};

/* yo dawg, I heard you like assembly, so I put assembly inside the cpu, so you can run
assembly while you run assembly */
static uint16_t uop_rom[][16] = {
    ...
    [ISA_OPCODE_ADD_ACCH_ACCL] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_ADD, ISA_REG_ACCL, 1),
        MOV_RR  (ISA_REG_ACCH, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_ADD_ACCW_IMM16] = {
        MOV_RR  (ISA_REG_ADDR_LATCH, ISA_REG_IP, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    ...
    [ISA_OPCODE_ADD_ACCW_BASE] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCW, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_ADD, ISA_REG_BASE, 1),
        MOV_RR  (ISA_REG_ACCW, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_ADD_ACCW_STT] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCW, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_ADD, ISA_REG_STT, 1),
        MOV_RR  (ISA_REG_ACCW, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_ADD_ACCW_STB] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCW, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_ADD, ISA_REG_STB, 1),
        MOV_RR  (ISA_REG_ACCW, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_ADD_BASE_IMM16] = {
        MOV_RR  (ISA_REG_ADDR_LATCH, ISA_REG_IP, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    ...
    [ISA_OPCODE_ADD_BASE_ACCW] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_BASE, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_ADD, ISA_REG_ACCW, 1),
        MOV_RR  (ISA_REG_BASE, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_ADD_BASE_STT] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_BASE, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    ...
    [ISA_OPCODE_SUB_ACCL_IMM8] = {
        ...
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCL, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_SUB, ISA_REG_DATA_LATCH, 1),
        MOV_RR  (ISA_REG_ACCL, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        IP_OP   (IP_OP_INC1)
    },
    [ISA_OPCODE_SUB_ACCL_ACCH] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCL, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_SUB, ISA_REG_ACCH, 1),
        MOV_RR  (ISA_REG_ACCL, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_SUB_ACCH_IMM8] = {
        MOV_RR  (ISA_REG_ADDR_LATCH, ISA_REG_IP, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    ...
    [ISA_OPCODE_SUB_ACCH_ACCL] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_SUB, ISA_REG_ACCL, 1),
        MOV_RR  (ISA_REG_ACCH, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_SUB_ACCW_IMM16] = {
        MOV_RR  (ISA_REG_ADDR_LATCH, ISA_REG_IP, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    ...
    [ISA_OPCODE_SUB_ACCW_BASE] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCW, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_SUB, ISA_REG_BASE, 1),
        MOV_RR  (ISA_REG_ACCW, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_SUB_ACCW_STT] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCW, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_SUB, ISA_REG_STT, 1),
        MOV_RR  (ISA_REG_ACCW, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_SUB_ACCW_STB] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCW, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_SUB, ISA_REG_STB, 1),
        MOV_RR  (ISA_REG_ACCW, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_SUB_BASE_IMM16] = {
        MOV_RR  (ISA_REG_ADDR_LATCH, ISA_REG_IP, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    ...
    [ISA_OPCODE_SUB_BASE_ACCW] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_BASE, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_SUB, ISA_REG_ACCW, 1),
        MOV_RR  (ISA_REG_BASE, ISA_REG_ALU_LATCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    },
    [ISA_OPCODE_SUB_BASE_STT] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_BASE, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
    ...
    [ISA_OPCODE_CMP_ACCL_IMM8] = {
        ...
        MOV_RM  (MOV_RM_WIDTH_BYTE),
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCL, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_CMP, ISA_REG_DATA_LATCH, 1),
        IP_OP   (IP_OP_INC1)
    },
    [ISA_OPCODE_CMP_ACCL_ACCH] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCL, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_CMP, ISA_REG_ACCH, 1),
    },
    [ISA_OPCODE_CMP_ACCH_IMM8] = {
        MOV_RR  (ISA_REG_ADDR_LATCH, ISA_REG_IP, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        MOV_RM  (MOV_RM_WIDTH_BYTE),
    ...
    [ISA_OPCODE_CMP_ACCH_ACCL] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCH, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_CMP, ISA_REG_ACCL, 1)
    },
    [ISA_OPCODE_CMP_ACCW_IMM16] = {
        MOV_RR  (ISA_REG_ADDR_LATCH, ISA_REG_IP, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        MOV_RM  (MOV_RM_WIDTH_WORD),
    ...
    [ISA_OPCODE_CMP_ACCW_BASE] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_ACCW, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_CMP, ISA_REG_BASE, 1)
    },
    [ISA_OPCODE_CMP_BASE_IMM16] = {
        MOV_RR  (ISA_REG_ADDR_LATCH, ISA_REG_IP, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        MOV_RM  (MOV_RM_WIDTH_WORD),
    ...
    [ISA_OPCODE_CMP_BASE_ACCW] = {
        MOV_RR  (ISA_REG_ALU_LATCH, ISA_REG_BASE, MOV_RR_VALUE_UOP, MOV_RR_VALUE_UOP),
        ALU_OP  (ALU_OP_CMP, ISA_REG_ACCW, 1)
    },
    ...
    [ISA_OPCODE_MOV_DST_I_SRC_IMM16] = {
        ...
        ALU_OP  (ALU_OP_ADD, ISA_REG_DATA_LATCH, 0),
